...
| Table | Transfer | Двухстрочная структура | P/table-transfer-1440x900.png | B/table-transfer-1440x900.png | table-transfer: пара «A → B» в колонке счёта, money-only «→ сумма», ≥3 amount-спанов; unit buildTransferRowPresentation; строка 52px | PASS |
